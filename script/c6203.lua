...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Special Summon/Scale (Monster Effect)
...
function s.descon(e,tp,eg,ep,ev,re,r,rp)
	return re:IsMonsterEffect() and Duel.IsExistingMatchingCard(s.stfilter,tp,0,LOCATION_ONFIELD,1,nil) and not Duel.HasFlagEffect(tp,id)
end
...
function s.spfilter(c,e,tp)
	return c:IsType(TYPE_PENDULUM) and c:ListsCode(6200) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_ATTACK+POS_FACEDOWN_DEFENSE)
end
