--Hammerhead, Sand Swimmer of The Beast
local s,id=GetID()
...
function s.repop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(Card.IsFaceup,tp,0,LOCATION_SZONE,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(id,2)) then
...
function s.chposop(e,tp,eg,ep,ev,re,r,rp)
	...
	e9:SetCountLimit(1)
	e9:SetCondition(s.defposcon)
	e9:SetOperation(s.defposop)
...
function s.defposop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
